...
public class Countries {
  ...
  extends AbstractMap<String,String> {
    ...
    extends AbstractSet<Map.Entry<String,String>> {
      ...
      //implements java.util.AbstractCollection<java.util.Map.Entry<java.lang.String,java.lang.String>>.size
    ...
    //implements java.util.AbstractMap<java.lang.String,java.lang.String>.entrySet
  ...
  static Map<String,String> select(final int size) {
    return new FlyweightMap() {
    	//overrides net.mindview.util.Countries.FlyweightMap.entrySet
      public Set<Map.Entry<String,String>> entrySet() {
